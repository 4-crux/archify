...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.domain': ['A domain model diagram generated by Archify.', '由 Archify 生成的领域模型图。'],
  'diagram.description.erd': ['An entity relationship diagram generated by Archify.', '由 Archify 生成的实体关系图。'],
  'diagram.description.http-call': ['An HTTP call diagram generated by Archify.', '由 Archify 生成的 HTTP 调用图。'],
  ...
  'node.context.domain': ['Domain model', '领域模型'],
  'node.context.erd': ['Database schema', '数据库模式'],
  'node.context.http-call': ['HTTP call map', 'HTTP 调用图'],
  ...
  'legend.domain.aggregate-root': ['aggregate root', '聚合根'],
  'legend.domain.entity': ['entity', '实体'],
  'legend.domain.value-object': ['value object', '值对象'],
  'legend.domain.enum': ['enum', '枚举'],
  'legend.domain.domain-event': ['domain event', '领域事件'],
  'legend.domain.domain-service': ['domain service', '领域服务'],
  'legend.erd.table': ['table', '表'],
  'legend.erd.view': ['view', '视图'],
  'legend.erd.junction': ['junction table', '关联表'],
  'legend.http-call.frontend': ['frontend', '前端'],
  'legend.http-call.gateway': ['gateway', '网关'],
  'legend.http-call.service': ['service', '服务'],
  'legend.http-call.worker': ['worker', '工作进程'],
  'legend.http-call.external': ['external', '外部系统'],
  ...
  'viewer.kind.aggregate-root': ['Aggregate root', '聚合根'],
  'viewer.kind.entity': ['Entity', '实体'],
  'viewer.kind.value-object': ['Value object', '值对象'],
  'viewer.kind.enum': ['Enum', '枚举'],
  'viewer.kind.domain-event': ['Domain event', '领域事件'],
  'viewer.kind.domain-service': ['Domain service', '领域服务'],
  'viewer.kind.table': ['Table', '表'],
  'viewer.kind.view': ['View', '视图'],
  'viewer.kind.junction': ['Junction table', '关联表'],
  'viewer.kind.gateway': ['Gateway', '网关'],
  'viewer.kind.service': ['Service', '服务'],
  'viewer.kind.worker': ['Worker', '工作进程'],
  ...
  'viewer.preset.4crux': ['4Crux', '4Crux'],
  'viewer.preset.4crux.hint': ['4Crux company identity', '4Crux 企业视觉识别'],
  ...
  'viewer.preset.badge.4crux': ['4CRUX / SYSTEM MAP', '4CRUX / 系统地图'],
  ...
  'viewer.nav.notes': ['Suggest changes', '提出修改建议'],
  'viewer.nav.notes.title': ['Change notes (A)', '修改笔记（A）'],
  'viewer.nav.notes.short': ['NOTES', '笔记'],
  'viewer.notes.eyebrow': ['Suggest changes', '提出修改建议'],
  'viewer.notes.title': ['Change notes', '修改笔记'],
  'viewer.notes.close': ['Close change notes', '关闭修改笔记'],
  'viewer.notes.instruction': ['Notes mode is on. Click a node, lane, boundary, or relationship, describe what should change, then copy every note as one report for your AI assistant.', '笔记模式已开启。点击节点、泳道、边界或关系，描述需要的修改，然后把全部笔记复制为一份报告交给 AI 助手。'],
  'viewer.notes.textLabel': ['Change request', '修改请求'],
  'viewer.notes.placeholder': ['Example: explode this box into a separate lane with more detail.', '示例：把这个节点展开为一条包含更多细节的独立泳道。'],
  'viewer.notes.save': ['Save note', '保存笔记'],
  'viewer.notes.cancel': ['Cancel', '取消'],
  'viewer.notes.delete': ['Delete', '删除'],
  'viewer.notes.list': ['Saved change notes', '已保存的修改笔记'],
  'viewer.notes.empty': ['No notes yet. Click an element on the diagram to write the first change request.', '还没有笔记。点击图中的元素即可写下第一条修改请求。'],
  'viewer.notes.missing': ['not in this artifact', '不在当前产物中'],
  'viewer.notes.clearAll': ['Clear all', '全部清除'],
  'viewer.notes.copy': ['Copy changes', '复制修改'],
  'viewer.notes.trigger.on': ['Notes mode on: click an element to suggest a change (A)', '笔记模式已开启：点击元素即可提出修改（A）'],
  'viewer.notes.trigger.off': ['Change notes (A)', '修改笔记（A）'],
  'viewer.notes.status.ready': ['Click an element on the diagram to add or edit a note.', '点击图中的元素以添加或编辑笔记。'],
  'viewer.notes.status.new': ['New note for {label}.', '为 {label} 新建笔记。'],
  'viewer.notes.status.editing': ['Editing the note for {label}.', '正在编辑 {label} 的笔记。'],
  'viewer.notes.status.blank': ['Write the change you want before saving.', '保存前请先写下需要的修改。'],
  'viewer.notes.status.saved': ['Saved the note for {label}. {count} note(s) ready to copy.', '已保存 {label} 的笔记。{count} 条笔记可复制。'],
  'viewer.notes.status.deleted': ['Note deleted. {count} note(s) remain.', '笔记已删除。剩余 {count} 条。'],
  'viewer.notes.status.cleared': ['All notes cleared.', '已清除全部笔记。'],
  'viewer.notes.status.copied': ['Copied {count} note(s) as a change report. Paste it into your AI assistant.', '已将 {count} 条笔记复制为修改报告。粘贴到 AI 助手即可。'],
  'viewer.notes.status.copyFailed': ['Copy failed. Select the notes manually or try again.', '复制失败。请手动选择笔记或重试。'],
  'viewer.notes.toast.copied': ['Change notes copied', '修改笔记已复制'],
  'viewer.export.copyChangeNotes': ['Copy change notes', '复制修改笔记'],
  'viewer.export.clipboardMarkdown': ['Markdown report to clipboard', 'Markdown 报告到剪贴板'],
  'viewer.guide.shortcut.notes': ['Change notes', '修改笔记'],
