...
const diagramTypes = ['workflow', 'sequence', 'dataflow', 'lifecycle', 'architecture', 'domain', 'erd', 'http-call'];
...
for (const type of diagramTypes) {
  ...
  // Export names must be identifiers; hyphenated types export in camelCase.
  schemaIds[type.replace(/-([a-z])/g, (_match, letter) => letter.toUpperCase())] = schema.$id;
}
